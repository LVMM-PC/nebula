...
const SubPopupMenu = {
  ...
  watch: {
    __propsSymbol__() {
      ...
      const storeActiveKey = this.getStore().getState().activeKey[
        this.getEventKey()
      ];
      const originalActiveKey =
        "activeKey" in props ? props.activeKey : storeActiveKey;
  ...
  methods: {
    ...
    step(direction) {
      ...
      const activeKey = this.getStore().getState().activeKey[
        this.getEventKey()
      ];
    ...
    renderCommonMenuItem(child, i, extraProps) {
      ...
      if (!childProps.disabled) {
        ...
        this.instanceArrayKeyIndexMap[key] = Object.keys(
