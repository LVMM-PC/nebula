  ...
  methods: {
    monthCellRender2(value) {
      ...
      const monthCellRender =
        this.monthCellRender || $scopedSlots.monthCellRender || noop;
      return (
    ...
    dateCellRender2(value) {
      ...
      const dateCellRender =
        this.dateCellRender || $scopedSlots.dateCellRender || noop;
      return (
    ...
    renderCalendar(locale, localeCode) {
      ...
      const monthCellRender =
        monthFullCellRender ||
        $scopedSlots.monthFullCellRender ||
        this.monthCellRender2;
      const dateCellRender =
        dateFullCellRender ||
        $scopedSlots.dateFullCellRender ||
        this.dateCellRender2;
